...
EXTERNAL FORM SEG_HOME_PASSWORD, SIS_HEADER_TOOLBAR, ORG_HOME_ORGANIZER, SIS_STATUS_ESTADO, SIS_HOME_INICIO
...
SET CLASSLIB TO &lcFRX2AnyLibrary IN FRX2Any.APP ADDITIVE && ALIAS FRX2Any

IF TYPE("_DOBRA") = "O"  && Validar si se creó el objeto _DOBRA
	_DOBRA.PasswordWindow 	= [SEG_HOME_PASSWORD]
